...
public class FenetreCoordonnees2 extends JFrame {

    private JPanel panel;
    private JLabel portCountLabel;
    private Bateau boats[] = new boats[10];
    ...
    public FenetreCoordonnees2() {
        setTitle("Gestion de Bateau");
        setSize(800, 800);
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

        portCountLabel = new JLabel("Ile une : 0                    Ile deux : 0 ");
        ...
        panel = new JPanel() {
            protected void paintComponent(Graphics g) {
                ...
                for (Bateau boat : boats) {
                    g.drawImage(imageBateau, 0, 0, 100, 100, this);
                }
